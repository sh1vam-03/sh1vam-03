...
<div align="center" style="margin: 30px auto; max-width: 1200px; width: calc(100% - 30px); padding: 0 15px;">
  ...
  <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
    ...
    <tr>
      <td style="padding: 10px; width: 35%;">
        <img src="https://github-readme-stats.vercel.app/api/top-langs/?username=sh1vam-03&layout=compact&hide_border=true&title_color=9b5de5&text_color=dcdcdc&bg_color=dark" alt="Most Used Languages" width="1000"/>
      </td>
       <td style="padding: 10px; width: 35%;">
